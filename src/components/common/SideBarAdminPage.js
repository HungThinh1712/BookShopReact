        ...
        >
          <Sidenav.Body>
            <Nav>
              ...
              <Dropdown
                eventKey="3"
                title={t("Admin_Home_BreadCrumbs.2")}
              ...
              >
                ...
                <Dropdown.Item
                  ...
                  eventKey="3-1"
                >
                  {t("Admin_Home_BreadCrumbs.21")}
                </Dropdown.Item>
                {topAdmin === true ? (
                  <Dropdown.Item
                    onClick={() =>
                      props.history.push("/admin/usermanagement_page")
                    }
                    icon={<Icon icon="user-circle" />}
                    eventKey="3-2"
                  >
                    {t("Admin_Home_BreadCrumbs.22")}
                  </Dropdown.Item>
                ) : null}
                <Dropdown.Item
                  onClick={() =>
                    props.history.push("/admin/typemanagement_page")
                  }
                  icon={<Icon icon="book" />}
                  eventKey="3-3"
                >
                  {t("Admin_Home_BreadCrumbs.23")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() =>
                  ...
                  eventKey="3-4"
                >
                  {t("Admin_Home_BreadCrumbs.26")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() =>
                    props.history.push("/admin/authormanagement_page")
                  }
                  icon={<Icon icon="peoples" />}
                  eventKey="3-5"
                >
                  {t("Admin_Home_BreadCrumbs.25")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() =>
                    props.history.push("/admin/pulishinghousemanagement_page")
                  }
                  icon={<Icon icon="simplybuilt" />}
                  eventKey="3-6"
                >
                  {t("Admin_Home_BreadCrumbs.24")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => props.history.push("/admin/promotions")}
              ...
              <Dropdown
                eventKey="4"
                title={t("Admin_Home_BreadCrumbs.10")}
              ...
              >
                <Dropdown.Item
                  ...
                  eventKey="4-1"
                >
                  {t("Admin_Home_BreadCrumbs.27")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => props.history.push("/admin/topfivebooks")}
