              ...
              <div className="card">
                <div className="card-body cart">
                  <div className="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" className="img-fluid mb-4 mr-3" />
                    ...
                    <h4>Thêm một vài sản phẩm vào giỏ hàng để bé thỏ nhà mình có tiền mua váy</h4> <button className="btn btn-primary cart-btn-transform m-3" onClick={() => props.history.push('/')}>Tiếp tục mua sắm</button>
                  </div>
                </div>
              </div>
            </div>
